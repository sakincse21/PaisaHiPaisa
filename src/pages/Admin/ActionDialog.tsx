...
const ActionDialog = ({ userId }: { userId: string }) => {
  ...
  const [getSingleUser, { data }] = useLazyGetSingleUserQuery();
  ...
  return (
    <div className="w-full flex justify-end items-center my-3">
      <Dialog open={openDialog} onOpenChange={setOpenDialog}>
        <DialogTrigger>
          <span className="py-2 px-4 rounded-lg border-2 border-gray-500">
            Update User
          </span>
        </DialogTrigger>
                  ...
                  render={({ field }) => (
                    <FormItem className="flex-1">
                      ...
                      >
                        ...
                        <SelectContent defaultValue={userData?.status}>
